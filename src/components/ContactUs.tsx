      ...
      <div className={styles.header}>
        <div className={styles.contactLink}>
          <a
            ...
            className={styles.sara}
          >
            <img src={sara} className={styles.imageSara} />
            <div className={styles.text2}>Sara (22) 99837-1359</div>
          </a>
          <a
            href="https://api.whatsapp.com/send?phone=5522998371359"
        ...
        <div className={styles.contactLink}>
          <a href="https://api.whatsapp.com/send?phone=5522997927387">
            <img src={michele} className={styles.image} />
